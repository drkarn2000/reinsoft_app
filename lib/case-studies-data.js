export const caseStudies = [
    ...
    },
    {
        ...
        shortDescription: "A Laravel-based property management platform developed for a UK client, integrating Zoho CRM to streamline landlord, tenant, and property management workflows.",
        industry: "Real Estate / Property Management",
        techStack: ["Laravel", "HTML5", "CSS3", "JavaScript", "Bootstrap", "MySQL", "Zoho CRM"],
        image: "/assets/supported_living.png",
        liveLink: "https://landlord.supportedlivingproperty.co.uk/",
        overview: "The Landlord Management System is a web-based platform developed for Supported Living Property, a UK-based organization managing supported accommodation and landlord services. The platform helps landlords and property managers efficiently manage property records, tenant information, documentation, and operational workflows. Integrated with Zoho services, the system automates business processes and centralizes property-related data, enabling streamlined communication and improved management efficiency.",
        problem: "Property management organizations often struggle with managing multiple property records, tracking landlord and tenant information, handling property documentation, lack of centralized operational systems, and manual data entry across multiple tools. The client required a digital system capable of organizing property operations while integrating with existing CRM tools like Zoho.",
        solution: "We developed a centralized landlord management platform that provides property and landlord record management, tenant data organization, integration with Zoho CRM for workflow automation, secure document and record management, a centralized administrative dashboard, and streamlined property management operations. The system simplifies property administration and ensures better visibility into property and tenant records.",
        features: [
            {
                title: "Property Management",
                points: ["Manage property listings and details", "Track property ownership and availability", "Maintain property records"],
                icon: "Layout"
            },
            {
                title: "Landlord Management",
                points: ["Store landlord profiles", "Manage contact and property relationships", "Maintain documentation"],
                icon: "Users"
            },
            {
                title: "Tenant Information System",
                points: ["Manage tenant profiles", "Track tenancy details", "Maintain occupancy records"],
                icon: "FileText"
            },
            {
                title: "Zoho Integration",
                points: ["CRM data synchronization", "Automated workflow integration", "Improved data management"],
                icon: "Zap"
            },
            {
                title: "Document Management",
                points: ["Upload and manage property documents", "Maintain records for compliance and verification"],
                icon: "ClipboardCheck"
            }
        ],
        process: [
            {
                ...
                description: "Analyzed property management workflows used by the client.",
                points: ["Landlord and property tracking", "Tenant record management", "CRM integration requirements"]
            },
            {
                stage: "System Design",
                description: "Designed a scalable property management architecture.",
                points: ["Admin dashboard", "Data management modules", "CRM integration"]
            },
            {
                stage: "Development",
                description: "Built the platform using Laravel framework.",
                points: ["Property management module", "Landlord and tenant database", "Zoho CRM integration", "Document management system"]
            },
            {
                stage: "Testing & Optimization",
                description: "Ensured platform reliability and security.",
                points: ["Workflow testing", "API integration testing", "Data validation and security checks"]
            },
            {
                stage: "Deployment & Maintenance",
                description: "Configured production environment and monitoring.",
                points: ["Server configuration", "Database optimization", "Ongoing support and updates"]
            }
        ],
        results: [
            { metric: "Data Handling", value: "Automated" },
            { metric: "Efficiency", value: "Improved" },
            { metric: "Records", value: "Centralized" },
            { metric: "Zoho CRM", value: "Integrated" }
        ],
        screenshots: [
            { title: "Dashboard Overview", url: "/assets/supported_living.png" }
        ]
    },
    {
    ...
    {
        slug: "vridez",
        title: "Vridez Managed Mobility & Transportation Fleet Services Platform",
