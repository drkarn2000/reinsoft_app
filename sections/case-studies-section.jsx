    ...
    return (
        <section className="mt-20 max-w-6xl mx-auto px-4 sm:px-6">
            <div className="text-center mb-12">
                ...
                <p className="text-gray-700 dark:text-gray-300 max-w-3xl mx-auto text-base/relaxed">
            ...
            <motion.div
                className="relative rounded-2xl overflow-hidden shadow-2xl global-orange-glow bg-gradient-to-b from-white/80 to-white dark:from-black/80 dark:to-slate-900 border border-black/10 dark:border-white/10"
            ...
            >
                ...
                <div className="relative h-64 md:h-80 w-full overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-b from-transparent to-white/90 dark:to-slate-900/90 z-10" />
                    <Image
                ...
                <div className="relative z-20 p-8 md:p-12 -mt-20 md:mt-[-100px]">
                    <div className="flex flex-wrap items-center gap-4 mb-8">
                        <h3 className="text-xl md:text-2xl font-bold text-pink-500">Professional Services Business</h3>
                        <span className="px-3 py-1 text-xs font-medium text-gray-700 dark:text-gray-300 border border-black/20 dark:border-gray-600 rounded-full bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                        <div>
                            <h4 className="text-sm font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider mb-3">Challenge</h4>
                            <p className="text-black dark:text-gray-200 text-sm/relaxed">
                        ...
                        <div>
                            <h4 className="text-sm font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider mb-3">Solution</h4>
                            <p className="text-black dark:text-gray-200 text-sm/relaxed">
