...
const testimonials = [
    {
        id: 1,
        review: "I want to take a moment to express my deepest gratitude and appreciation for Manpreet, who has been an absolute pillar of support throughout the development of my web-based project for Biswakarma Jewellery Shilpalaya. From the very beginning, Manpreet showcased not only excellent technical expertise in React and web development but also a true sense of ownership and dedication that went far beyond expectations. He approached every challenge with a calm, solution-oriented mindset and was always there to support me no matter how big or small the issue was.",
        name: "Sujoye Dhar",
        role: "CTO, https://biswakarmagold.com/",
        rating: 5,
    ...
    {
        id: 2,
        review: "The custom CRM they built for us completely streamlined our operations. What used to take days now takes hours. Their team is incredibly responsive and technical. Amarjeet did an exceptional job with converting my Custom CRM, he is very good at what he does and he doesn't give up until its perfect. His knowledge and skills are fantastic! I have worked with lots of developers and I can hands down say he has outperformed them all! Great work Amarjeet!! Would highly recommend him to anyone!",
        name: "Ehsan F. (UK)",
        role: "Product Owner,",
        rating: 5,
    ...
    {
        id: 3,
        review: "Working with Reinsoft on our SaaS platform was a game-changer. They understood our vision perfectly and the Laravel backend and flutter app is rock solid. Best work delivered, on time and prompt in response, this was my 4th time. i will be working again for sure. He understands clearly what i need and implements it correctly. also helps going beyond the box and makes my experience great, recommended developer go for it.",
