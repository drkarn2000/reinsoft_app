            ...
            >
                <div className="space-y-8 text-gray-700 dark:text-gray-200">
                    ...
                    <div className="space-y-4">
                        <h2 className="text-xl font-semibold text-black dark:text-white">Information We Collect</h2>
                    ...
                    <div className="space-y-4">
                        <h2 className="text-xl font-semibold text-black dark:text-white">How We Use Your Information</h2>
                    ...
                    <div className="space-y-4">
                        <h2 className="text-xl font-semibold text-black dark:text-white">Data Security</h2>
                        <p>We take reasonable measures to protect your personal data from unauthorized access, misuse, or disclosure.</p>
                    </div>

                    <div className="space-y-4">
                        <h2 className="text-xl font-semibold text-black dark:text-white">Cookies</h2>
                    ...
                    <div className="space-y-4">
                        <h2 className="text-xl font-semibold text-black dark:text-white">Third-Party Services</h2>
                    ...
                    <div className="space-y-4">
                        <h2 className="text-xl font-semibold text-black dark:text-white">Your Consent</h2>
                        <p>By using our website and submitting your information, you consent to this Privacy Policy.</p>
                    </div>

                    <div className="space-y-4">
                        <h2 className="text-xl font-semibold text-black dark:text-white">Contact Information</h2>
                        <p>If you have any questions regarding this Privacy Policy, or if you would like to submit a request regarding your data, you can contact us at:</p>
                        <a href="mailto:info@reinsoft.tech" className="inline-flex items-center gap-2 text-black dark:text-white font-medium hover:text-gray-300 transition">
                            <MailIcon className="size-4" />
                            info@reinsoft.tech
                        </a>
                        <p className="pt-4 text-sm text-gray-500">We are fully committed to compliance with international privacy standards and data security regulations. This privacy policy is actively monitored and updated.</p>
                    </div>
                </div>
            </motion.section>
        </main>
