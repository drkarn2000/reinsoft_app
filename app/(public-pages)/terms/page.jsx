            ...
            >
                <div className="space-y-8 text-gray-200">
                    ...
                    <div className="space-y-4">
                        <h2 className="text-xl font-semibold text-black dark:text-white">Services</h2>
                    ...
                    <div className="space-y-4">
                        <h2 className="text-xl font-semibold text-black dark:text-white">Project Scope & Payments</h2>
                    ...
                    <div className="space-y-4">
                        <h2 className="text-xl font-semibold text-black dark:text-white">Client Responsibilities</h2>
                    ...
                    <div className="space-y-4">
                        <h2 className="text-xl font-semibold text-black dark:text-white">Intellectual Property</h2>
                        <ul className="list-disc list-inside space-y-2 ml-2">
                    ...
                    <div className="space-y-4">
                        <h2 className="text-xl font-semibold text-black dark:text-white">Limitation of Liability</h2>
                    ...
                    <div className="space-y-4">
                        <h2 className="text-xl font-semibold text-black dark:text-white">Governing Law</h2>
                        <p>These terms shall be governed by and interpreted in accordance with the laws of India.</p>
                    </div>

                    <div className="space-y-4">
                        <h2 className="text-xl font-semibold text-black dark:text-white">Changes to Terms</h2>
                        <p>We reserve the right to update these Terms & Conditions at any time without prior notice.</p>
                    </div>

                    <div className="space-y-4">
                        <h2 className="text-xl font-semibold text-black dark:text-white">Contact</h2>
