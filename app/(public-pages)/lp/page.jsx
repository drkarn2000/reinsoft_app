            ...
            <main className='px-4'>
                ...
                <motion.section className="flex flex-col items-center">
                    ...
                    >
                        ...
                        <a href="https://api.whatsapp.com/send?phone=918968369582" target="_blank" rel="noopener noreferrer" className="btn max-md:w-full glass flex items-center justify-center gap-2 py-3">
