...
export default function CaseStudyClient({ initialProject }) {
    const { slug } = useParams();
    const searchParams = useSearchParams();
    const hideDemo = searchParams.get('hideDemo') === 'true';
    
    // Use initialProject from server, or fallback to client-side lookup if needed
    const project = initialProject || caseStudies.find(cs => cs.slug === slug);
            ...
            <section className="relative pt-32 pb-10 overflow-hidden border-b border-white/5">
                ...
                <div className="container mx-auto px-6">
                    ...
                    >
                        ...
                        {/* H1 is now rendered in the server component for SEO, but we can re-render it here for smooth entry if needed, or just leave it for the server */}
